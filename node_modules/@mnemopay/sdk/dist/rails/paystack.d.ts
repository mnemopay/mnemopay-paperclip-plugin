...
export declare class PaystackRail implements PaymentRail {
    ...
    private static readonly MAX_PROCESSED_REFS;
    private static readonly REF_TTL_MS;
     ...
     */
    createHold(amount: number, reason: string, agentId: string, options?: HoldOptions): Promise<PaystackHoldResult>;
    /**
